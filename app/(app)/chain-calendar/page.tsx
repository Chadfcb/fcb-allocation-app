...
// chain_events/chain_event_materials tables — and, as of 2026-09-05, NO
// distributor association (per Chad: "remove the distributors from the
// chain calendar" — it originally had it, matching Events Calendar; now
// matches Social Media Calendar instead) — see ChainCalendarPageClient.tsx.
// Gated by the same "events_calendar" section as Events Calendar for now,
